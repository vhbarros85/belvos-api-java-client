...
public class TransactionsApiTest {
     ...
     */
    @Test
    public void destroyTransactionTest() {
        UUID id = null;
        api.destroyTransaction(id);
     ...
     */
    @Test
    public void detailTransactionTest() {
        UUID id = null;
        Transaction response = api.detailTransaction(id);
    ...
    public void listTransactionsTest() {
        ...
        TransactionsPaginatedResponse response = api.listTransactions(link, page, pageSize, account, filters);
     ...
     */
    @Test
    public void patchTransactionsTest() {
        PatchBody patchBody = null;
        List<Transaction> response = api.patchTransactions(patchBody);
    ...
    public void retrieveTransactionsTest() {
        TransactionsRequest transactionsRequest = null;
        List<Transaction> response = api.retrieveTransactions(transactionsRequest);
