...
import com.vhbarros.belvo.client.invoker.auth.api.OwnersApi;
import com.vhbarros.belvo.client.model.Owner;
import com.vhbarros.belvo.client.model.OwnerFilters;
import com.vhbarros.belvo.client.model.OwnersPaginatedResponse;
...
public class OwnersApiTest {
     ...
     */
    @Test
    public void detailOwnerTest() {
        UUID id = null;
        Owner response = api.detailOwner(id);
    ...
    public void listOwnersTest() {
        ...
        OwnerFilters filters = null;
        OwnersPaginatedResponse response = api.listOwners(page, pageSize, filters);
     ...
     */
    @Test
    public void patchOwnersTest() {
        PatchBody patchBody = null;
        List<Owner> response = api.patchOwners(patchBody);
     ...
     */
    @Test
    public void retrieveOwnersTest() {
        StandardRequest standardRequest = null;
        List<Owner> response = api.retrieveOwners(standardRequest);
