...
/**
 * API tests for InvestmentPortfoliosBetaApi
 */
@Ignore
public class InvestmentPortfoliosBetaApiTest {

    private final InvestmentPortfoliosBetaApi api = new InvestmentPortfoliosBetaApi();
     ...
     */
    @Test
    public void destroyPortfolioTest() {
        UUID id = null;
        api.destroyPortfolio(id);
     ...
     */
    @Test
    public void detailPortfolioTest() {
        UUID id = null;
        InvestmentsPortfolio response = api.detailPortfolio(id);
     ...
     */
    @Test
    public void listPortfolioTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        InvestmentPortfolioFilters filters = null;
        InvestmentsPortfoliosPaginatedResponse response = api.listPortfolio(page, pageSize, link, filters);
     ...
     */
    @Test
    public void patchPortfolioTest() {
        PatchBodyWithoutSaveData patchBodyWithoutSaveData = null;
        InvestmentsPortfolio response = api.patchPortfolio(patchBodyWithoutSaveData);
     ...
     */
    @Test
    public void retrievePortfolioTest() {
        StandardRequest standardRequest = null;
        InvestmentsPortfolio response = api.retrievePortfolio(standardRequest);
