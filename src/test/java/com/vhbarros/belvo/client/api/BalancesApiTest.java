...
import com.vhbarros.belvo.client.invoker.auth.api.BalancesApi;
...
public class BalancesApiTest {
     ...
     */
    @Test
    public void destroyBalanceTest() {
        UUID id = null;
        api.destroyBalance(id);
    ...
    public void detailBalanceTest() {
        UUID id = null;
        Balance response = api.detailBalance(id);
    ...
    public void listBalancesTest() {
        ...
        UUID link = null;
        UUID account = null;
        BalanceFilters filters = null;
        BalancesPaginatedResponse response = api.listBalances(page, pageSize, link, account, filters);
     ...
     */
    @Test
    public void patchBalancesTest() {
        PatchBody patchBody = null;
        List<Balance> response = api.patchBalances(patchBody);
     ...
     */
    @Test
    public void retrieveBalancesTest() {
        BalancesRequest balancesRequest = null;
        List<Balance> response = api.retrieveBalances(balancesRequest);
