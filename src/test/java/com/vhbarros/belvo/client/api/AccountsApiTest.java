...
public class AccountsApiTest {
     ...
     */
    @Test
    public void destroyAccountTest() {
        UUID id = null;
        api.destroyAccount(id);
     ...
     */
    @Test
    public void detailAccountTest() {
        UUID id = null;
        Account response = api.detailAccount(id);
    ...
    public void listAccountsTest() {
        ...
        AccountsPaginatedResponse response = api.listAccounts(page, pageSize, link, filters);
     ...
     */
    @Test
    public void patchAccountsTest() {
        PatchBody patchBody = null;
        List<Account> response = api.patchAccounts(patchBody);
    ...
    public void retrieveAccountsTest() {
        ...
        List<Account> response = api.retrieveAccounts(standardRequest);
