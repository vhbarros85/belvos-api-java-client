...
public class IncomesApiTest {
     ...
     */
    @Test
    public void destroyIncomesTest() {
        UUID id = null;
        api.destroyIncomes(id);
     ...
     */
    @Test
    public void detailIncomeTest() {
        UUID id = null;
        List<Income> response = api.detailIncome(id);
     ...
     */
    @Test
    public void listIncomesTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID account = null;
        IncomeFilters filters = null;
        IncomesPaginatedResponse response = api.listIncomes(page, pageSize, account, filters);
     ...
     */
    @Test
    public void patchIncomesTest() {
        PatchBody patchBody = null;
        List<Income> response = api.patchIncomes(patchBody);
     ...
     */
    @Test
    public void retrieveIncomeTest() {
        IncomesRequest incomesRequest = null;
        List<Income> response = api.retrieveIncome(incomesRequest);
