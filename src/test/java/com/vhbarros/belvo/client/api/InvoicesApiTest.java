...
public class InvoicesApiTest {
     ...
     */
    @Test
    public void detailInvoiceTest() {
        UUID id = null;
        InvoiceWithId response = api.detailInvoice(id);
    ...
    public void listInvoicesTest() {
        ...
        InvoicesResponsePaginatedResponse response = api.listInvoices(page, pageSize, link, filters);
     ...
     */
    @Test
    public void retrieveInvoicesTest() {
        InvoicesRequest invoicesRequest = null;
        List<InvoiceWithId> response = api.retrieveInvoices(invoicesRequest);
