...
/**
 * API tests for ReceivableTransactionsBetaApi
 */
@Ignore
public class ReceivableTransactionsBetaApiTest {

    private final ReceivableTransactionsBetaApi api = new ReceivableTransactionsBetaApi();
     ...
     */
    @Test
    public void destroyReceivableTransactionTest() {
        UUID id = null;
        api.destroyReceivableTransaction(id);
     ...
     */
    @Test
    public void detailReceivableTransactionTest() {
        UUID id = null;
        ReceivablesTransaction response = api.detailReceivableTransaction(id);
     ...
     */
    @Test
    public void listReceivableTransactionsTest() {
        Integer page = null;
        UUID link = null;
        UUID account = null;
        ReceivableTransactionFilters filters = null;
        ReceivablesTransactionsPaginatedResponse response = api.listReceivableTransactions(page, link, account, filters);
     ...
     */
    @Test
    public void retrieveReceivableTransactionsTest() {
        ReceivableTransactionRequest receivableTransactionRequest = null;
        ReceivablesTransaction response = api.retrieveReceivableTransactions(receivableTransactionRequest);
