...
public class RiskInsightsApiTest {
    ...
    private final RiskInsightsApi api = new RiskInsightsApi();
     ...
     */
    @Test
    public void destroyRiskInsightsTest() {
        UUID id = null;
        api.destroyRiskInsights(id);
     ...
     */
    @Test
    public void detailRiskInsightsTest() {
        UUID id = null;
        List<RiskInsights> response = api.detailRiskInsights(id);
     ...
     */
    @Test
    public void listRiskInsightsTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        RiskInsightFilters filters = null;
        RiskInsightsPaginatedResponse response = api.listRiskInsights(page, pageSize, link, filters);
     ...
     */
    @Test
    public void patchRiskInsightsTest() {
        PatchBody patchBody = null;
        List<RiskInsights> response = api.patchRiskInsights(patchBody);
     ...
     */
    @Test
    public void retrieveRiskInsightsTest() {
        StandardRequest standardRequest = null;
        List<RiskInsights> response = api.retrieveRiskInsights(standardRequest);
