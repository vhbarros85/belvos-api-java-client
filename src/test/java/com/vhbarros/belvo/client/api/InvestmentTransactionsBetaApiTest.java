...
/**
 * API tests for InvestmentTransactionsBetaApi
 */
@Ignore
public class InvestmentTransactionsBetaApiTest {

    private final InvestmentTransactionsBetaApi api = new InvestmentTransactionsBetaApi();
     ...
     */
    @Test
    public void destroyInvestmentTransactionTest() {
        UUID id = null;
        api.destroyInvestmentTransaction(id);
     ...
     */
    @Test
    public void detailInvestmentTransactionTest() {
        UUID id = null;
        InvestmentsInstrumentTransaction response = api.detailInvestmentTransaction(id);
     ...
     */
    @Test
    public void listInvestmentTransactionsTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        UUID portfolio = null;
        InvestmentTransactionFilters filters = null;
        InvestmentsTransactionsPaginatedResponse response = api.listInvestmentTransactions(page, pageSize, link, portfolio, filters);
     ...
     */
    @Test
    public void patchInvestmentsTransactionsTest() {
        PatchBodyWithoutSaveData patchBodyWithoutSaveData = null;
        InvestmentsInstrumentTransaction response = api.patchInvestmentsTransactions(patchBodyWithoutSaveData);
     ...
     */
    @Test
    public void retrieveInstrumentTransactionTest() {
        InstrumentTransactionRequest instrumentTransactionRequest = null;
        InvestmentsInstrumentTransaction response = api.retrieveInstrumentTransaction(instrumentTransactionRequest);
