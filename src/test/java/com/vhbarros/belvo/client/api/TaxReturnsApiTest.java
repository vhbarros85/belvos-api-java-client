...
public class TaxReturnsApiTest {
     ...
     */
    @Test
    public void destroyTaxReturnTest() {
        UUID id = null;
        api.destroyTaxReturn(id);
     ...
     */
    @Test
    public void detailTaxReturnTest() {
        UUID id = null;
        RetrieveTaxReturns200ResponseInner response = api.detailTaxReturn(id);
     ...
     */
    @Test
    public void listTaxReturnsTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        TaxReturnFilters filters = null;
        ListTaxReturns200Response response = api.listTaxReturns(page, pageSize, link, filters);
     ...
     */
    @Test
    public void retrieveTaxReturnsTest() {
        RetrieveTaxReturnsRequest retrieveTaxReturnsRequest = null;
        List<RetrieveTaxReturns200ResponseInner> response = api.retrieveTaxReturns(retrieveTaxReturnsRequest);
