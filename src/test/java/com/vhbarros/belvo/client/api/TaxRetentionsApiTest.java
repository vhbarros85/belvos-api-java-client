...
public class TaxRetentionsApiTest {
    ...
    private final TaxRetentionsApi api = new TaxRetentionsApi();
     ...
     */
    @Test
    public void destroyTaxRetentionTest() {
        UUID id = null;
        api.destroyTaxRetention(id);
     ...
     */
    @Test
    public void detailTaxRetentionsTest() {
        UUID id = null;
        TaxRetentions response = api.detailTaxRetentions(id);
     ...
     */
    @Test
    public void listTaxRetentionsTest() {
        Integer page = null;
        UUID link = null;
        InvestmentTransactionFilters filters = null;
        TaxRetentionsPaginatedResponse response = api.listTaxRetentions(page, link, filters);
     ...
     */
    @Test
    public void retrieveTaxRetentionsTest() {
        TaxRetentionsRequest taxRetentionsRequest = null;
        List<TaxRetentions> response = api.retrieveTaxRetentions(taxRetentionsRequest);
