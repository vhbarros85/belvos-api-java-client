...
public class RecurringExpensesApiTest {
    ...
    private final RecurringExpensesApi api = new RecurringExpensesApi();
     ...
     */
    @Test
    public void destroyRecurringExpenseTest() {
        String id = null;
        api.destroyRecurringExpense(id);
     ...
     */
    @Test
    public void detailRecurringExpenseTest() {
        String id = null;
        List<RecurringExpenses> response = api.detailRecurringExpense(id);
     ...
     */
    @Test
    public void listRecurringExpensesTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        UUID account = null;
        RecurringExpenseFilters filters = null;
        RecurringExpensesPaginatedResponse response = api.listRecurringExpenses(page, pageSize, link, account, filters);
     ...
     */
    @Test
    public void patchRecurringExpensesTest() {
        PatchBody patchBody = null;
        List<RecurringExpenses> response = api.patchRecurringExpenses(patchBody);
     ...
     */
    @Test
    public void retrieveRecurringExpensesTest() {
        StandardRequest standardRequest = null;
        List<RecurringExpenses> response = api.retrieveRecurringExpenses(standardRequest);
