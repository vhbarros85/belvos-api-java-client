...
public class TaxComplianceStatusApiTest {
    ...
    private final TaxComplianceStatusApi api = new TaxComplianceStatusApi();
     ...
     */
    @Test
    public void destroyTaxComplianceStatusTest() {
        UUID id = null;
        api.destroyTaxComplianceStatus(id);
     ...
     */
    @Test
    public void detailTaxComplianceStatusTest() {
        UUID id = null;
        TaxComplianceStatus response = api.detailTaxComplianceStatus(id);
     ...
     */
    @Test
    public void listTaxComplianceStatusTest() {
        Integer page = null;
        Integer pageSize = null;
        UUID link = null;
        TaxComplianceStatusFilters filters = null;
        TaxComplianceStatusPaginatedResponse response = api.listTaxComplianceStatus(page, pageSize, link, filters);
     ...
     */
    @Test
    public void retrieveTaxComplianceStatusTest() {
        TaxComplianceStatusRequest taxComplianceStatusRequest = null;
        TaxComplianceStatus response = api.retrieveTaxComplianceStatus(taxComplianceStatusRequest);
