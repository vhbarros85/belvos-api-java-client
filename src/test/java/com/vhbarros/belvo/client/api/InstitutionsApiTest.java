...
public class InstitutionsApiTest {
     ...
     */
    @Test
    public void detailInstitutionTest() {
        String id = null;
        Institution response = api.detailInstitution(id);
    ...
    public void listInstitutionsTest() {
        ...
        InstitutionFilters filters = null;
        InstitutionsPaginatedResponse response = api.listInstitutions(page, pageSize, filters);
