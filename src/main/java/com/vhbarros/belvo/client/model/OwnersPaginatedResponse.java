 ...
 */
@JsonPropertyOrder({
  OwnersPaginatedResponse.JSON_PROPERTY_COUNT,
  OwnersPaginatedResponse.JSON_PROPERTY_NEXT,
  OwnersPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  OwnersPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, ownersPaginatedResponse.count) &&
        equalsNullable(this.next, ownersPaginatedResponse.next) &&
        equalsNullable(this.previous, ownersPaginatedResponse.previous) &&
