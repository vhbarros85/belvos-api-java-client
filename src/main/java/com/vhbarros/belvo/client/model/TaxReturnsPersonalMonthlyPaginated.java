 ...
 */
@JsonPropertyOrder({
  TaxReturnsPersonalMonthlyPaginated.JSON_PROPERTY_COUNT,
  TaxReturnsPersonalMonthlyPaginated.JSON_PROPERTY_NEXT,
  TaxReturnsPersonalMonthlyPaginated.JSON_PROPERTY_PREVIOUS,
  TaxReturnsPersonalMonthlyPaginated.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class TaxReturnsPersonalMonthlyPaginated extends HashMap<String, Object> {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxReturnsPersonalMonthlyPaginated.count) &&
        equalsNullable(this.next, taxReturnsPersonalMonthlyPaginated.next) &&
        equalsNullable(this.previous, taxReturnsPersonalMonthlyPaginated.previous) &&
