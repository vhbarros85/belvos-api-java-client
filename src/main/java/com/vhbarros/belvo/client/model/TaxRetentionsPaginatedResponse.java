 ...
 */
@JsonPropertyOrder({
  TaxRetentionsPaginatedResponse.JSON_PROPERTY_COUNT,
  TaxRetentionsPaginatedResponse.JSON_PROPERTY_NEXT,
  TaxRetentionsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  TaxRetentionsPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxRetentionsPaginatedResponse.count) &&
        equalsNullable(this.next, taxRetentionsPaginatedResponse.next) &&
        equalsNullable(this.previous, taxRetentionsPaginatedResponse.previous) &&
