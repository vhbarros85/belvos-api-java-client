 ...
 */
@JsonPropertyOrder({
  IncomesRequest.JSON_PROPERTY_LINK,
  IncomesRequest.JSON_PROPERTY_DATE_FROM,
  IncomesRequest.JSON_PROPERTY_DATE_TO,
  IncomesRequest.JSON_PROPERTY_TOKEN,
  IncomesRequest.JSON_PROPERTY_SAVE_DATA
})
