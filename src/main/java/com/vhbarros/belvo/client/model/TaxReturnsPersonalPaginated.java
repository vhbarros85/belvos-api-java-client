 ...
 */
@JsonPropertyOrder({
  TaxReturnsPersonalPaginated.JSON_PROPERTY_COUNT,
  TaxReturnsPersonalPaginated.JSON_PROPERTY_NEXT,
  TaxReturnsPersonalPaginated.JSON_PROPERTY_PREVIOUS,
  TaxReturnsPersonalPaginated.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class TaxReturnsPersonalPaginated extends HashMap<String, Object> {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxReturnsPersonalPaginated.count) &&
        equalsNullable(this.next, taxReturnsPersonalPaginated.next) &&
        equalsNullable(this.previous, taxReturnsPersonalPaginated.previous) &&
