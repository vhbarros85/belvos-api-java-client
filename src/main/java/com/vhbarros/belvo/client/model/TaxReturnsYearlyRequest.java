...
@JsonPropertyOrder({
  TaxReturnsYearlyRequest.JSON_PROPERTY_LINK,
  TaxReturnsYearlyRequest.JSON_PROPERTY_ATTACH_PDF,
  TaxReturnsYearlyRequest.JSON_PROPERTY_SAVE_DATA,
  TaxReturnsYearlyRequest.JSON_PROPERTY_TYPE,
  TaxReturnsYearlyRequest.JSON_PROPERTY_YEAR_FROM,
  TaxReturnsYearlyRequest.JSON_PROPERTY_YEAR_TO
})
...
public class TaxReturnsYearlyRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(link, attachPdf, saveData, type, yearFrom, yearTo);
  }
