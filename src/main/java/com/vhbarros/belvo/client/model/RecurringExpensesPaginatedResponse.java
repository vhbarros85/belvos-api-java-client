 ...
 */
@JsonPropertyOrder({
  RecurringExpensesPaginatedResponse.JSON_PROPERTY_COUNT,
  RecurringExpensesPaginatedResponse.JSON_PROPERTY_NEXT,
  RecurringExpensesPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  RecurringExpensesPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, recurringExpensesPaginatedResponse.count) &&
        equalsNullable(this.next, recurringExpensesPaginatedResponse.next) &&
        equalsNullable(this.previous, recurringExpensesPaginatedResponse.previous) &&
