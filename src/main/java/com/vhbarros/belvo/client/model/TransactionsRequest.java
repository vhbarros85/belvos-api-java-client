 ...
 */
@JsonPropertyOrder({
  TransactionsRequest.JSON_PROPERTY_LINK,
  TransactionsRequest.JSON_PROPERTY_ACCOUNT,
  TransactionsRequest.JSON_PROPERTY_DATE_FROM,
  TransactionsRequest.JSON_PROPERTY_DATE_TO,
  TransactionsRequest.JSON_PROPERTY_TOKEN,
  TransactionsRequest.JSON_PROPERTY_SAVE_DATA
})
...
public class TransactionsRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(link, account, dateFrom, dateTo, token, saveData);
  }
