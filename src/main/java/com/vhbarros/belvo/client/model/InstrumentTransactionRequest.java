 ...
 */
@JsonPropertyOrder({
  InstrumentTransactionRequest.JSON_PROPERTY_LINK,
  InstrumentTransactionRequest.JSON_PROPERTY_DATE_FROM,
  InstrumentTransactionRequest.JSON_PROPERTY_DATE_TO,
  InstrumentTransactionRequest.JSON_PROPERTY_TOKEN,
  InstrumentTransactionRequest.JSON_PROPERTY_SAVE_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class InstrumentTransactionRequest {
  ...
  public InstrumentTransactionRequest() {
  }

  public InstrumentTransactionRequest link(UUID link) {
  ...
  **/
  ...
  public InstrumentTransactionRequest dateFrom(String dateFrom) {
  ...
  **/
  ...
  public InstrumentTransactionRequest dateTo(String dateTo) {
  ...
  **/
  ...
  public InstrumentTransactionRequest token(String token) {
  ...
  **/
  ...
  public InstrumentTransactionRequest saveData(Boolean saveData) {
   ...
   /**
   * Indicates whether or not to persist the data in Belvo. When set to &#x60;false&#x60;, the data won&#39;t be persisted.
   * @return saveData
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether or not to persist the data in Belvo. When set to `false`, the data won't be persisted.")
  ...
  public boolean equals(Object o) {
    ...
    InstrumentTransactionRequest instrumentTransactionRequest = (InstrumentTransactionRequest) o;
    return Objects.equals(this.link, instrumentTransactionRequest.link) &&
        Objects.equals(this.dateFrom, instrumentTransactionRequest.dateFrom) &&
        Objects.equals(this.dateTo, instrumentTransactionRequest.dateTo) &&
        Objects.equals(this.token, instrumentTransactionRequest.token) &&
        Objects.equals(this.saveData, instrumentTransactionRequest.saveData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(link, dateFrom, dateTo, token, saveData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InstrumentTransactionRequest {\n");
