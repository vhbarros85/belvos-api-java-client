 ...
 */
@JsonPropertyOrder({
  InstitutionsFormField.JSON_PROPERTY_NAME,
  InstitutionsFormField.JSON_PROPERTY_TYPE,
  InstitutionsFormField.JSON_PROPERTY_LABEL,
  InstitutionsFormField.JSON_PROPERTY_VALIDATION,
  InstitutionsFormField.JSON_PROPERTY_PLACEHOLDER,
  InstitutionsFormField.JSON_PROPERTY_VALIDATION_MESSAGE,
  InstitutionsFormField.JSON_PROPERTY_VALUES
})
