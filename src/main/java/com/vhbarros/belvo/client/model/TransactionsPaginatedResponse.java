 ...
 */
@JsonPropertyOrder({
  TransactionsPaginatedResponse.JSON_PROPERTY_COUNT,
  TransactionsPaginatedResponse.JSON_PROPERTY_NEXT,
  TransactionsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  TransactionsPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, transactionsPaginatedResponse.count) &&
        equalsNullable(this.next, transactionsPaginatedResponse.next) &&
        equalsNullable(this.previous, transactionsPaginatedResponse.previous) &&
