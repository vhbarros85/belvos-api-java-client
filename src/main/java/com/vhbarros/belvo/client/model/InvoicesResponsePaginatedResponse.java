 ...
 */
@JsonPropertyOrder({
  InvoicesResponsePaginatedResponse.JSON_PROPERTY_COUNT,
  InvoicesResponsePaginatedResponse.JSON_PROPERTY_NEXT,
  InvoicesResponsePaginatedResponse.JSON_PROPERTY_PREVIOUS,
  InvoicesResponsePaginatedResponse.JSON_PROPERTY_RESULTS
})
...
public class InvoicesResponsePaginatedResponse {
  ...
  private List<InvoiceWithId> results = null;
  ...
  **/
  ...
  public InvoicesResponsePaginatedResponse results(List<InvoiceWithId> results) {
    
    this.results = results;
    return this;
  }

  public InvoicesResponsePaginatedResponse addResultsItem(InvoiceWithId resultsItem) {
  ...
  **/
  ...
  public List<InvoiceWithId> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(List<InvoiceWithId> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, invoicesResponsePaginatedResponse.count) &&
        equalsNullable(this.next, invoicesResponsePaginatedResponse.next) &&
        equalsNullable(this.previous, invoicesResponsePaginatedResponse.previous) &&
