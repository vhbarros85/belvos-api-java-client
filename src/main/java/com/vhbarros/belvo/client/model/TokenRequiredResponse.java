...
import com.vhbarros.belvo.client.model.TokenRequiredResponseTokenGenerationData;
...
@JsonPropertyOrder({
  TokenRequiredResponse.JSON_PROPERTY_CODE,
  TokenRequiredResponse.JSON_PROPERTY_MESSAGE,
  TokenRequiredResponse.JSON_PROPERTY_REQUEST_ID,
  TokenRequiredResponse.JSON_PROPERTY_SESSION,
  TokenRequiredResponse.JSON_PROPERTY_EXPIRY,
  TokenRequiredResponse.JSON_PROPERTY_LINK,
  TokenRequiredResponse.JSON_PROPERTY_TOKEN_GENERATION_DATA
})
...
public class TokenRequiredResponse {
  ...
  public static final String JSON_PROPERTY_TOKEN_GENERATION_DATA = "token_generation_data";
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TOKEN_GENERATION_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, message, requestId, session, expiry, link, tokenGenerationData);
  }
