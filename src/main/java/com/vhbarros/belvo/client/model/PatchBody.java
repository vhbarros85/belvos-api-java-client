...
@JsonPropertyOrder({
  PatchBody.JSON_PROPERTY_SESSION,
  PatchBody.JSON_PROPERTY_TOKEN,
  PatchBody.JSON_PROPERTY_LINK,
  PatchBody.JSON_PROPERTY_SAVE_DATA
})
...
public class PatchBody {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(session, token, link, saveData);
  }
