...
@JsonPropertyOrder({
  TaxReturnsMonthlyRequest.JSON_PROPERTY_LINK,
  TaxReturnsMonthlyRequest.JSON_PROPERTY_ATTACH_PDF,
  TaxReturnsMonthlyRequest.JSON_PROPERTY_SAVE_DATA,
  TaxReturnsMonthlyRequest.JSON_PROPERTY_TYPE,
  TaxReturnsMonthlyRequest.JSON_PROPERTY_DATE_FROM,
  TaxReturnsMonthlyRequest.JSON_PROPERTY_DATE_TO
})
...
public class TaxReturnsMonthlyRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(link, attachPdf, saveData, type, dateFrom, dateTo);
  }
