 ...
 */
@JsonPropertyOrder({
  ReceivablesTransactionsPaginatedResponse.JSON_PROPERTY_COUNT,
  ReceivablesTransactionsPaginatedResponse.JSON_PROPERTY_NEXT,
  ReceivablesTransactionsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  ReceivablesTransactionsPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, receivablesTransactionsPaginatedResponse.count) &&
        equalsNullable(this.next, receivablesTransactionsPaginatedResponse.next) &&
        equalsNullable(this.previous, receivablesTransactionsPaginatedResponse.previous) &&
