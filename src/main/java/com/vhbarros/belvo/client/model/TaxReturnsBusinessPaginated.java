 ...
 */
@JsonPropertyOrder({
  TaxReturnsBusinessPaginated.JSON_PROPERTY_COUNT,
  TaxReturnsBusinessPaginated.JSON_PROPERTY_NEXT,
  TaxReturnsBusinessPaginated.JSON_PROPERTY_PREVIOUS,
  TaxReturnsBusinessPaginated.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class TaxReturnsBusinessPaginated extends HashMap<String, Object> {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxReturnsBusinessPaginated.count) &&
        equalsNullable(this.next, taxReturnsBusinessPaginated.next) &&
        equalsNullable(this.previous, taxReturnsBusinessPaginated.previous) &&
