 ...
 */
@JsonPropertyOrder({
  TaxRetentionsRequest.JSON_PROPERTY_LINK,
  TaxRetentionsRequest.JSON_PROPERTY_DATE_FROM,
  TaxRetentionsRequest.JSON_PROPERTY_DATE_TO,
  TaxRetentionsRequest.JSON_PROPERTY_TYPE,
  TaxRetentionsRequest.JSON_PROPERTY_ATTACH_XML,
  TaxRetentionsRequest.JSON_PROPERTY_SAVE_DATA
})
...
public class TaxRetentionsRequest {
  ...
  **/
  ...
  public TaxRetentionsRequest type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of tax retention in relation to the invoice (from the perspective of the Link owner).  - `OUTFLOW` relates to a tax retention for a sent invoice. - `INFLOW` related to a tax retention for a received invoice. ")
