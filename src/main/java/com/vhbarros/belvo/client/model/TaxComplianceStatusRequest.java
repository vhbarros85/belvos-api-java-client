 ...
 */
@JsonPropertyOrder({
  TaxComplianceStatusRequest.JSON_PROPERTY_LINK,
  TaxComplianceStatusRequest.JSON_PROPERTY_ATTACH_PDF,
  TaxComplianceStatusRequest.JSON_PROPERTY_SAVE_DATA
})
...
public class TaxComplianceStatusRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(link, attachPdf, saveData);
  }
