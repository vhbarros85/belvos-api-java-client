 ...
 */
@JsonPropertyOrder({
  InvestmentsPortfoliosPaginatedResponse.JSON_PROPERTY_COUNT,
  InvestmentsPortfoliosPaginatedResponse.JSON_PROPERTY_NEXT,
  InvestmentsPortfoliosPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  InvestmentsPortfoliosPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, investmentsPortfoliosPaginatedResponse.count) &&
        equalsNullable(this.next, investmentsPortfoliosPaginatedResponse.next) &&
        equalsNullable(this.previous, investmentsPortfoliosPaginatedResponse.previous) &&
