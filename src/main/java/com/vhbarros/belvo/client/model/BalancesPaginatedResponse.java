 ...
 */
@JsonPropertyOrder({
  BalancesPaginatedResponse.JSON_PROPERTY_COUNT,
  BalancesPaginatedResponse.JSON_PROPERTY_NEXT,
  BalancesPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  BalancesPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, balancesPaginatedResponse.count) &&
        equalsNullable(this.next, balancesPaginatedResponse.next) &&
        equalsNullable(this.previous, balancesPaginatedResponse.previous) &&
