 ...
 */
@JsonPropertyOrder({
  RiskInsightsPaginatedResponse.JSON_PROPERTY_COUNT,
  RiskInsightsPaginatedResponse.JSON_PROPERTY_NEXT,
  RiskInsightsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  RiskInsightsPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, riskInsightsPaginatedResponse.count) &&
        equalsNullable(this.next, riskInsightsPaginatedResponse.next) &&
        equalsNullable(this.previous, riskInsightsPaginatedResponse.previous) &&
