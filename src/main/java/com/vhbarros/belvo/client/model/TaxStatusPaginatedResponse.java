 ...
 */
@JsonPropertyOrder({
  TaxStatusPaginatedResponse.JSON_PROPERTY_COUNT,
  TaxStatusPaginatedResponse.JSON_PROPERTY_NEXT,
  TaxStatusPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  TaxStatusPaginatedResponse.JSON_PROPERTY_RESULTS
})
...
public class TaxStatusPaginatedResponse {
  ...
  private List<TaxStatus> results = null;
  ...
  **/
  ...
  public TaxStatusPaginatedResponse results(List<TaxStatus> results) {
    
    this.results = results;
    return this;
  }

  public TaxStatusPaginatedResponse addResultsItem(TaxStatus resultsItem) {
  ...
  **/
  ...
  public List<TaxStatus> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(List<TaxStatus> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxStatusPaginatedResponse.count) &&
        equalsNullable(this.next, taxStatusPaginatedResponse.next) &&
        equalsNullable(this.previous, taxStatusPaginatedResponse.previous) &&
