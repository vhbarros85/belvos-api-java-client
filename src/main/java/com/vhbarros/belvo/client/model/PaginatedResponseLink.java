 ...
 */
@JsonPropertyOrder({
  PaginatedResponseLink.JSON_PROPERTY_COUNT,
  PaginatedResponseLink.JSON_PROPERTY_NEXT,
  PaginatedResponseLink.JSON_PROPERTY_PREVIOUS,
  PaginatedResponseLink.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedResponseLink.count) &&
        equalsNullable(this.next, paginatedResponseLink.next) &&
        equalsNullable(this.previous, paginatedResponseLink.previous) &&
