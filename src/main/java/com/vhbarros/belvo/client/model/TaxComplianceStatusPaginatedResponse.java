 ...
 */
@JsonPropertyOrder({
  TaxComplianceStatusPaginatedResponse.JSON_PROPERTY_COUNT,
  TaxComplianceStatusPaginatedResponse.JSON_PROPERTY_NEXT,
  TaxComplianceStatusPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  TaxComplianceStatusPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxComplianceStatusPaginatedResponse.count) &&
        equalsNullable(this.next, taxComplianceStatusPaginatedResponse.next) &&
        equalsNullable(this.previous, taxComplianceStatusPaginatedResponse.previous) &&
