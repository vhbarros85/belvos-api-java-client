 ...
 */
@JsonPropertyOrder({
  TaxReturnsBusinessMonthlyPaginated.JSON_PROPERTY_COUNT,
  TaxReturnsBusinessMonthlyPaginated.JSON_PROPERTY_NEXT,
  TaxReturnsBusinessMonthlyPaginated.JSON_PROPERTY_PREVIOUS,
  TaxReturnsBusinessMonthlyPaginated.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class TaxReturnsBusinessMonthlyPaginated extends HashMap<String, Object> {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, taxReturnsBusinessMonthlyPaginated.count) &&
        equalsNullable(this.next, taxReturnsBusinessMonthlyPaginated.next) &&
        equalsNullable(this.previous, taxReturnsBusinessMonthlyPaginated.previous) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(count, hashCodeNullable(next), hashCodeNullable(previous), results, super.hashCode());
  }
