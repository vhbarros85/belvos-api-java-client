 ...
 */
@JsonPropertyOrder({
  InvestmentsTransactionsPaginatedResponse.JSON_PROPERTY_COUNT,
  InvestmentsTransactionsPaginatedResponse.JSON_PROPERTY_NEXT,
  InvestmentsTransactionsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  InvestmentsTransactionsPaginatedResponse.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-16T15:47:17.569Z[Etc/UTC]")
public class InvestmentsTransactionsPaginatedResponse {
  ...
  private List<InvestmentsInstrumentTransaction> results = null;

  public InvestmentsTransactionsPaginatedResponse() {
  }

  public InvestmentsTransactionsPaginatedResponse count(Integer count) {
  ...
  **/
  ...
  public InvestmentsTransactionsPaginatedResponse next(String next) {
  ...
  **/
  ...
  public InvestmentsTransactionsPaginatedResponse previous(String previous) {
  ...
  **/
  ...
  public InvestmentsTransactionsPaginatedResponse results(List<InvestmentsInstrumentTransaction> results) {
    
    this.results = results;
    return this;
  }

  public InvestmentsTransactionsPaginatedResponse addResultsItem(InvestmentsInstrumentTransaction resultsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of link objects.")
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<InvestmentsInstrumentTransaction> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(List<InvestmentsInstrumentTransaction> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    InvestmentsTransactionsPaginatedResponse investmentsTransactionsPaginatedResponse = (InvestmentsTransactionsPaginatedResponse) o;
    return Objects.equals(this.count, investmentsTransactionsPaginatedResponse.count) &&
        equalsNullable(this.next, investmentsTransactionsPaginatedResponse.next) &&
        equalsNullable(this.previous, investmentsTransactionsPaginatedResponse.previous) &&
        Objects.equals(this.results, investmentsTransactionsPaginatedResponse.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvestmentsTransactionsPaginatedResponse {\n");
