 ...
 */
@JsonPropertyOrder({
  AccountsPaginatedResponse.JSON_PROPERTY_COUNT,
  AccountsPaginatedResponse.JSON_PROPERTY_NEXT,
  AccountsPaginatedResponse.JSON_PROPERTY_PREVIOUS,
  AccountsPaginatedResponse.JSON_PROPERTY_RESULTS
})
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, accountsPaginatedResponse.count) &&
        equalsNullable(this.next, accountsPaginatedResponse.next) &&
        equalsNullable(this.previous, accountsPaginatedResponse.previous) &&
