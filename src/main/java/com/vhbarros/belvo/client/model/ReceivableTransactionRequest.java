 ...
 */
@JsonPropertyOrder({
  ReceivableTransactionRequest.JSON_PROPERTY_LINK,
  ReceivableTransactionRequest.JSON_PROPERTY_DATE_FROM,
  ReceivableTransactionRequest.JSON_PROPERTY_DATE_TO,
  ReceivableTransactionRequest.JSON_PROPERTY_TOKEN,
  ReceivableTransactionRequest.JSON_PROPERTY_SAVE_DATA
})
