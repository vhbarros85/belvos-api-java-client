...
@JsonPropertyOrder({
  InstitutionAccount.JSON_PROPERTY_NAME,
  InstitutionAccount.JSON_PROPERTY_TYPE
})
...
public class InstitutionAccount {
  ...
  **/
  ...
  public InstitutionAccount type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of institution.  Can be either:    - `bank`   - `fiscal`   - `gig` ")
